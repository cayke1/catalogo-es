<div class="container">
    ...
    <form class="form-container" action="/add-product" method="POST" enctype="multipart/form-data" id="productForm">
        ...
        <div class="button-group">
            ...
            <button id="submit_btn" type="submit" class="btn btn-primary">Cadastrar Produto</button>
        </div>
    </form>
</div>

<script src="/app/public/js/add-product.js"></script>